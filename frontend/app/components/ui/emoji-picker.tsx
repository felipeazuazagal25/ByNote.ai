  ...
  return (
    ...
    >
      ...
      <EmojiPickerPrimitive.Search
        className="focus:outline-none outline-hidden placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-transparent py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50"
